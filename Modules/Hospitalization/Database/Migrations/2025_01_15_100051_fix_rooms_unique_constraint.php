...
/**
 * Migration : Correction de la contrainte unique sur rooms
 * 
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasColumn('rooms', 'hospital_id')) {
            return;
        }
        ...
        Schema::table('rooms', function (Blueprint $table) {
            ...
            try {
                ...
                $indexes = DB::select("SHOW INDEX FROM rooms WHERE Column_name = 'code' AND Non_unique = 0");
        ...
        Schema::table('rooms', function (Blueprint $table) {
            ...
            $table->unique(['hospital_id', 'code'], 'rooms_hospital_code_unique');
        });
    }
    ...
    {
        Schema::table('rooms', function (Blueprint $table) {
            $table->dropUnique('rooms_hospital_code_unique');
            $table->unique('code');
        });
    }
};
