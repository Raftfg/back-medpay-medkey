...
/**
 * Migration : Correction de la contrainte unique sur services
 * 
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('services', function (Blueprint $table) {
            ...
            try {
                ...
                $indexes = DB::select("SHOW INDEX FROM services WHERE Column_name = 'code' AND Non_unique = 0");
        ...
        Schema::table('services', function (Blueprint $table) {
            ...
            $table->unique(['hospital_id', 'code'], 'services_hospital_code_unique');
        });
    }
    ...
    {
        Schema::table('services', function (Blueprint $table) {
            $table->dropUnique('services_hospital_code_unique');
            $table->unique('code');
        });
    }
};
