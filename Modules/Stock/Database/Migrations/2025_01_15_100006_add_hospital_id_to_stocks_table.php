...
/**
 * Migration : Ajout de hospital_id à la table stocks
 * 
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Assigner les stocks existants en fonction du hospital_id de l'utilisateur
        ...
        if ($firstHospital) {
            // Mettre à jour les stocks en fonction du hospital_id de l'utilisateur
            DB::statement('
                UPDATE stocks s
